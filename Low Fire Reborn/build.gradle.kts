...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        val file = upload(1144421, remapJar)
        file.displayName = "[${project.extra["minecraft_version"] as String}] Low Fire Reborn"
...
modrinth {
    ...
    projectId.set("low-fire-reborn")
    uploadFile.set(tasks.remapJar)
    gameVersions.addAll(project.extra["minecraft_version"] as String)
    versionName.set("[${project.extra["minecraft_version"] as String}] Low Fire Reborn")
    dependencies {
